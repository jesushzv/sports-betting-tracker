  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/user", {
        ...
        body: JSON.stringify({
          name: formData.name,
          startingBankroll: formData.startingBankroll ? parseFloat(formData.startingBankroll) : null,
        }),
      })
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, startingBankroll: e.target.value }))}
                      placeholder="Enter your starting bankroll"
                    />
                    <p className="text-sm text-muted-foreground">
                      This is used to calculate your net profit/loss from your starting point.
                    </p>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold">-</div>
                  <div className="text-sm text-muted-foreground">Total Parlays</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold">-</div>
